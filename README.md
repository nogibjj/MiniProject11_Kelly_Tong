...
3. Raw Data is loaded into the notebook
...
4. Data is transformed into database format and prepared for query
...
5. Job Workflows is created to automate ingesting, preparing, analyzing
